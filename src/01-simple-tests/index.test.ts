...
describe('simpleCalculator tests', () => {
  ...
  test('should multiply two numbers', () => {
    const result = simpleCalculator({ a: nums.first, b: nums.second, action: Action.Multiply });
    expect(result).toBe(nums.first * nums.second);
  });
  ...
  test('should exponentiate two numbers', () => {
    const result = simpleCalculator({ a: nums.first, b: nums.second, action: Action.Exponentiate});
    expect(result).toBe(nums.first ** nums.second);
  });

  test('should return null for invalid action', () => {
    const invalidAction = '~';
    const result = simpleCalculator({ a: nums.first, b: nums.second, action: invalidAction });
